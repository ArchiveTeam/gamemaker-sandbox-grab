...
LUA_SHA1 = get_hash(os.path.join(CWD, 'sandbox.lua'))
...
project = Project(
    ...
    project_html="""
        ...
        <a href="http://tracker.archiveteam.org/gamemakersandbox/">Leaderboard</a> &middot;
        <a href="http://archiveteam.org/index.php?title=GameMaker_Sandbox">Wiki</a>
        </span></h2>
        <p>Video games!</p>
    """,
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="gamemaker"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
